...
//go:generate mockgen -source offset_store.go -destination mock_offset_store.go -self_package github.com/ssdev-go/rocketmq-client-go/consumer  --package consumer OffsetStore
