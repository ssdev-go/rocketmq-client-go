...
//go:generate mockgen -source client.go -destination mock_client.go -self_package github.com/ssdev-go/rocketmq-client-go/internal  --package internal RMQClient
